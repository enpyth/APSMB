...
drop table if exists public.apmbc_membership cascade;

create table public.apmbc_membership (
  id bigint generated by default as identity primary key,
...
insert into public.apmbc_membership (full_name, email, membership_type, is_verified, details) values
  (
    'Alice Zhang',
    'alice@example.com',
    'visitor',
